<%@ Page Language="C#" MasterPageFile="~/UI/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProjectCreate.aspx.cs" Inherits="btl_web_nangcao_task_management_system.UI.ProjectCreate" %>
...
<asp:Content ID="ContentProjectCreate" runat="server" ContentPlaceHolderID="mainContentPlaceHolder">
    <asp:Panel runat="server" ID="Panel1">
        ...
        <div class="form-row no-gutters">
            ...
            <div class="form-group col c-12 m-3 l-3">
                <asp:Label ID="Label5" runat="server" Text="Status:" AssociatedControlID="statusDropDownList"></asp:Label>
                <asp:DropDownList ID="statusDropDownList" runat="server" CssClass="form-control">
                </asp:DropDownList>
                <asp:Label ID="feedbackStatus" runat="server" CssClass="invalid-feedback"></asp:Label>
            </div>
        </div>
        <div class="form-group">
