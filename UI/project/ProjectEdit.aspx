<%@ Page Language="C#" MasterPageFile="~/UI/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProjectEdit.aspx.cs" Inherits="btl_web_nangcao_task_management_system.UI.ProjectEdit" %>
...
<asp:Content ID="ContentProjectEdit" runat="server" ContentPlaceHolderID="mainContentPlaceHolder">
    <asp:Panel runat="server" ID="Panel1">
        ...
        <div class="form-group">
            <asp:Label ID="Label1" runat="server" Text="Select Project to Edit" AssociatedControl="titleTextBox"></asp:Label>
        ...
        <div class="form-row no-gutters">
            ...
            <div class="form-group col c-12 m-3 l-3">
                <asp:Label ID="Label6" runat="server" Text="Status:" AssociatedControlID="statusDropDownList"></asp:Label>
