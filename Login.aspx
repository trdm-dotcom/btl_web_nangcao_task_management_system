<%@ Page Language="C#"  MasterPageFile="MasterPageAuthentication.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="btl_web_nangcao_task_management_system.page.authentication.Login" %>
...
<asp:Content ID="ContentLogin" runat="server" ContentPlaceHolderID="mainContentPlaceHolder">
    ...
    <asp:Button runat="server" CssClass="button" ID="loginButton" Text="Login" OnClick="loginButton_Click" onclientclick="return validateForm()"/>
    <div class="signup">
