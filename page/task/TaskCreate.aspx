<%@ Page Language="C#" MasterPageFile="~/page/MasterPage.Master" AutoEventWireup="true" CodeBehind="TaskCreate.aspx.cs" Inherits="btl_web_nangcao_task_management_system.page.task.TaskCreate" %>
...
<asp:Content ID="ContentTaskCreate" runat="server" ContentPlaceHolderID="mainContentPlaceHolder">
    <asp:Panel runat="server" ID="Panel1">
        ...
        <div class="form-group">
            ...
            <asp:DropDownList ID="projectDropDownList" runat="server" CssClass="form-control" OnSelectedIndexChanged="projectDropDownList_SelectedIndexChanged" OnDataBound="projectDropDownList_DataBound">
            </asp:DropDownList>
        ...
        <div class="form-row no-gutters">
            <div class="form-group col c-12 m-3 l-3">
                ...
                <asp:DropDownList ID="reporterDropDownList" runat="server" CssClass="form-control" Enabled="false" OnDataBound="reporterDropDownList_DataBound">
                </asp:DropDownList>
            </div>
            <div class="form-group col c-12 m-3 l-3">
                <asp:Label ID="Label6" runat="server" Text="Assignee:" AssociatedControlID="assigneeDropDownList"></asp:Label>
                <asp:DropDownList ID="assigneeDropDownList" runat="server" CssClass="form-control" OnDataBound="assigneeDropDownList_DataBound">
                </asp:DropDownList>
            </div>
            <div class="form-group col c-12 m-3 l-3">
                <asp:Label ID="Label8" runat="server" Text="QA:" AssociatedControlID="QADropDownList"></asp:Label>
                <asp:DropDownList ID="QADropDownList" runat="server" CssClass="form-control" OnDataBound="QADropDownList_DataBound">
                </asp:DropDownList>
            </div>
        </div>
        <div class="form-row no-gutters">
            ...
            <div class="form-group col c-12 m-3 l-3">
                ...
                <asp:DropDownList ID="priorityDropDownList" runat="server" CssClass="form-control" OnDataBound="priorityDropDownList_DataBound">
                </asp:DropDownList>
